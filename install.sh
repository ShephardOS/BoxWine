...
function wget-git-q {
    wget -q --retry-connrefused --tries=0 --header "PRIVATE-TOKEN: glpat-kj--11qKof3MZXBayzRV" "https://gitlab.com/api/v4/projects/$PROJECT_ID/repository/files/$1/raw?ref=main" -O $2
    return $?
}
...
echo "PRIVATE-TOKEN=glpat-kj--11qKof3MZXBayzRV
